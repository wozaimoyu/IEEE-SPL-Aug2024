...
for simulation_times = 1 %Set simulation times
...
%calculate Eq. (13)
[xindex,yindex] = calculate_eq_13(NS,varphi,delta,lambda);
geshu=length(xindex);
...
NMSE_GCCS=a/simulation_times;
NMSE_LS=b/simulation_times;
NMSE_OMP=c/simulation_times;
NMSE_GCCS_restricted=d/simulation_times;
NMSE_LS_restricted=e/simulation_times;
NMSE_OMP_restricted=f/simulation_times;
NMSE_lspro=g/simulation_times;
SNR=-10:5:30;
NMSE_GCCS=10*log10(NMSE_GCCS);
NMSE_LS=10*log10(NMSE_LS);
NMSE_OMP=10*log10(NMSE_OMP);
NMSE_GCCS_restricted=10*log10(NMSE_GCCS_restricted);
NMSE_LS_restricted=10*log10(NMSE_LS_restricted);
NMSE_OMP_restricted=10*log10(NMSE_OMP_restricted);
NMSE_GCCS=sort(NMSE_GCCS,'descend');
NMSE_LS=sort(NMSE_LS,'descend');
NMSE_OMP=sort(NMSE_OMP,'descend');
NMSE_GCCS_restricted=sort(NMSE_GCCS_restricted,'descend');
NMSE_LS_restricted=sort(NMSE_LS_restricted,'descend');
NMSE_OMP_restricted=sort(NMSE_OMP_restricted,'descend');
plot(SNR,NMSE_LS,'k-o',SNR,NMSE_OMP,'b-o',SNR,NMSE_LS_restricted,'k-*',SNR,NMSE_OMP_restricted,'b-*');
legend("LS","OMP","Sub-LS","Sub-OMP");
grid on;
xlabel("SNR");
ylabel("NMSE (dB)");
